 ...
 * @author yassine
 */
public class ModifierResEvent {

    private Form f;
    private Toolbar t;

    public ModifierResEvent() {

        f = new Form("Modifier", new FlowLayout(Component.CENTER, Component.CENTER));
        ...
        TextField nbr = new TextField("", String.valueOf(Vars.current_reservationevent.getNombrplaces()));
        ...
        modifier.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((nbr.getText().length() == 0) || (Float.parseFloat(nbr.getText()) < 0)) {
                    ...
                    res.update((int) Float.parseFloat(nbr.getText()));
