...
public class ReservationEnseigne {
    ...
    public ReservationEnseigne() {
        ...
        if (!rs.getReservations().isEmpty()) {
            ...
            c4.add(new Label("Date Res"));
            c4.add(new Label("Nbr Place"));
            ...
            for (Reservation r : rs.getReservations()) {
                ...
                Label date = new Label(new SimpleDateFormat("dd-MM-yyyy").format(r.getDatereservation()));
                Label nbr = new Label(String.valueOf(r.getNbplaces()));
                ...
                modifier.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        Vars.current_reservation = r;
                        ModifierResEns mre = new ModifierResEns();
                        mre.getF().show();
                    }
                });
