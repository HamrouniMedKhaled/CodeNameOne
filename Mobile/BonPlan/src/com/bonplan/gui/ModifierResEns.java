 ...
 * @author yassine
 */
public class ModifierResEns {

    private Form f;
    private Toolbar t;

    public ModifierResEns() {
        ...
        TextField nbr = new TextField("", String.valueOf(Vars.current_reservation.getNbplaces()));
        c1.add(nbr);
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((dt.getTime() - p.getDate().getTime()) > 0) {
                    ...
                    if ((nbr.getText().length() == 0) || (Float.parseFloat(nbr.getText()) < 0)) {
                        ...
                        rs.update((int) Float.parseFloat(nbr.getText()), p.getDate());
